  ...
  return (
    <Wrapper>
        ...
        <Strip backgroundColor={colors.green}>
            ...
            <Page nerrow>
                <Photo src='/assets/bookstore/int.png'/>
            </Page>
        </Strip>
        ...
        <Strip backgroundColor={colors.white} noPaddingBottom>
            <Page nerrow>
                <StripTitle align={"center"}> 
                    User Persona
                </StripTitle>
